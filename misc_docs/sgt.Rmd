...
```{r plot_compare_m_n, echo=FALSE}
plot(1:20, compare_m_n[1, ], type = "l", col = "red", 
     xlab = "time", ylab = "mean m", lwd = 3)
lines(compare_m_n[2, ], col = "green", lwd = 1.5, lty = 2)
legend("topleft", c("formula", "m_n"), col = c("red", "green"), 
...
plot(1:20, compare_s_n[1, ], type = "l",  col = "red", xlab = "time", ylab = "mean MAD", ylim = c(0, max(compare_s_n)))
lines(compare_s_n[2, ], col = "blue")
lines(compare_s_n[3, ], col = "green", lty = 2)
legend("topleft", c("formula 1", "formula 2", "MAD_n"), col = c("red", "blue", "green"), lty = c(1, 1, 2))
```
...
plot(1:20, compare_s_n[1, ], type = "l",  col = "red", 
     xlab = "time", ylab = "mean MAD", ylim = c(0, max(compare_s_n)))
lines(compare_s_n[2, ], col = "blue")
lines(compare_s_n[3, ], col = "green", lty = 2)
legend("topleft", c("formula 1", "formula 2", "MAD_n"), 
...
plot(1:20, compare_xi_n[1, ], type = "l", col = "red", 
...
```{r echo=FALSE}
plot(seq(2.1, 4, by = 0.1), x_rt_vect, xlab = "df (nu)", ylab = "s_hat")
```
...
plot(seq(2.1, 4, by = 0.1), x_rt_vect, xlab = "df (nu)", ylab = "m_hat")
```
...
```{r echo=FALSE}
df_vals <- seq(2.1, 8, by = 0.1)
plot(df_vals, m_sim_df[ ,"x_rt"], col = "blue",
     xlab = "df (nu)", ylab = "m_hat", type = "l", ylim = c(min(m_sim_df), max(m_sim_df)),
     main = "Simulation mean = 0.4, sd = 0.9, n = 1e6"
)
lines(x = df_vals, y = m_sim_df[ ,"x_std"], col = "red")
lines(x = df_vals, y = m_sim_df[ ,"x_sstd"], col = "green")
legend(x = 6.5, y = 0.402, legend = c("rt()", "rstd()", "rsstd"), col = c("blue", "red", "green"), lty = c(1,1,1))
```
...
```{r echo=FALSE}
df_vals <- seq(2.1, 8, by = 0.1)
plot(df_vals, sd_sim_df[ ,"x_rt"], col = "blue",
     xlab = "df (nu)", ylab = "s_hat", type = "l", ylim = c(min(sd_sim_df), max(sd_sim_df)),
     main = "Simulation sd = 0.9, n = 1e6"
)
lines(x = df_vals, y = sd_sim_df[ ,"x_std"], col = "red")
lines(x = df_vals, y = sd_sim_df[ ,"x_sstd"], col = "green")
legend(x = 6.5, y = 1.5, legend = c("rt()", "rstd()", "rsstd"), col = c("blue", "red", "green"), lty = c(1,1,1))
```
...
```{r echo=FALSE}
df_vals <- seq(2.1, 8, by = 0.1)
plot(df_vals, mad_sim_df[ ,"x_rt"], col = "blue",
     xlab = "df (nu)", ylab = "mad_hat", type = "l", ylim = c(min(mad_sim_df), max(mad_sim_df)),
     main = "Simulation sd = 0.9, n = 1e6"
)
lines(x = df_vals, y = mad_sim_df[ ,"x_std"], col = "red")
lines(x = df_vals, y = mad_sim_df[ ,"x_sstd"], col = "green")
legend(x = 6.5, y = 0.4, legend = c("rt()", "std()", "sstd()"), col = c("blue", "red", "green"), lty = c(1,1,1))
```


```{r echo=FALSE}
df_vals <- seq(2.1, 8, by = 0.1)
plot(df_vals, mad_sim_df[ ,"x_rt"]/sd_sim_df[ ,"x_rt"], col = "blue",
     xlab = "df (nu)", ylab = "MAD/sd", type = "l", ylim = c(min(mad_sim_df/sd_sim_df), 0.9),
     main = "MAD/sd ratio (simulation sd = 0.9, n = 1e6)"
)
lines(x = df_vals, y = mad_sim_df[ ,"x_std"]/sd_sim_df[ ,"x_std"], col = "red")
lines(x = df_vals, y = mad_sim_df[ ,"x_sstd"]/sd_sim_df[ ,"x_sstd"], col = "green")
abline(sqrt(2 / pi), 0, col = "gray")
legend(x = 6.5, y = 0.5, legend = c("rt()", "std()", "sstd()", "sqrt(2 / pi)"), col = c("blue", "red", "green", "gray"), lty = c(1,1,1))
```
...
"A review of Student’s t distribution and its generalizations.pdf"
...
## TODO:
## 1) line 957
##    func_name is not substituted, insted it prints as "param_func":
##      title = paste0("Means of simulations of ", func_name, " for skewed t"),
## 2) line 868
