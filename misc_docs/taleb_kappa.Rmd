...
NOTE  
See also *Rupert & Matteson: Statistics and Data Analysis for Financial Engineering*, p. 606, for calculation of $N_\text{eff}$.
...
For the analytical mean of the F-S Skewed $t$, see Li and Nadarajah: A review of Student’s t distribution and its generalizations, p. 10. (Typo: Should be $x$ instead of $s$. See Fernandez-Steel: On Bayesian Modelling Of Fat Tails And Skewness, eq. 2.5+2.6)
