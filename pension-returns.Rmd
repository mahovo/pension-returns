...
lines(x = c(2011:2023), y = exp(mhr), col = "#A020F0",  lty = 2, lwd = 1.5)
legend("bottom", legend = c("vmr", "vhr", "pmr", "phr", "mmr", "mhr"), col = c("#7AC5CD", "#76EEC6", "#CD6600", "#CD6600", "#A020F0", "#A020F0"), lty = c(1, 2, 1, 2, 1, 2), lwd = 2, ncol = 3 )
```
...
max_sum_plots <- list()
for(i in seq_along(fits)) {
  max_sum_plots[[i]] <- plot_max_sum(fits[[i]], 1e4)
}
