...
## Ranking
```{r}
knitr::kable(rank_summary(summary_df, sorting = c("hi", "hi", "hi", "hi")), digits = 3)
```
...
risk_percentiles_df <-  data.frame(
      ...
      Velliv_m = risk_percentiles(fit_vmr$dist_data, percent_vals, "max"),
      Velliv_m_l = risk_percentiles(fit_vmrl$dist_data, percent_vals, "max"),
      Velliv_h = risk_percentiles(fit_vhr$dist_data, percent_vals, "max"),
      PFA_m = risk_percentiles(fit_pmr$dist_data, percent_vals, "max"),
      PFA_h = risk_percentiles(fit_phr$dist_data, percent_vals, "max"),
      mix_m = risk_percentiles(fit_mmr$dist_data, percent_vals, "max"),
      mix_h = risk_percentiles(fit_mhr$dist_data, percent_vals, "max")
)
...
gain_percentiles_df <-  data.frame(
      #Percent = percent_vals,
      Velliv_m = risk_percentiles(fit_vmr$dist_data, percent_vals, "min"),
      Velliv_m_l = risk_percentiles(fit_vmrl$dist_data, percent_vals, "min"),
      Velliv_h = risk_percentiles(fit_vhr$dist_data, percent_vals, "min"),
      PFA_m = risk_percentiles(fit_pmr$dist_data, percent_vals, "min"),
      PFA_h = risk_percentiles(fit_phr$dist_data, percent_vals, "min"),
      mix_m = risk_percentiles(fit_mmr$dist_data, percent_vals, "min"),
      mix_h = risk_percentiles(fit_mhr$dist_data, percent_vals, "min")
)
...
mc_loss_percentiles_df <-  data.frame(
      ...
      Velliv_m_l = risk_percentiles(log(unlist(mc_vmrl$mc_df[20, ])/100), percent_vals, "max"),
...
mc_gain_percentiles_df <-  data.frame(
      ...
      Velliv_m_l = risk_percentiles(log(unlist(mc_vmrl$mc_df[20, ])/100), percent_vals, "min"),
...
mc_summary <- data.frame(
  ...
  Velliv_m_l = c(mc_vmrl$mc_m, mc_vmrl$mc_s, mc_vmrl$mc_min, mc_vmrl$mc_max, mc_vmrl$dao_probability_percent, mc_vmrl$percent_losing_paths),
...
rownames(mc_summary) <- c("mc_m", "mc_s", "mc_min", "mc_max", "dao_pct", "losing_pct")
```
...
```{r}
knitr::kable(rank_summary(mc_summary, sorting = c("hi", "lo", "hi", "hi", "lo", "lo")), digits = 3)
```
